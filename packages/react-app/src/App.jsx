  ...
  function recieveVoucher(clientAddress) {
    ...
    function processVoucher(voucher) {
      ...
      */
      ...
      const hashed = ethers.utils.keccak256(packed);
      const arrayified = ethers.utils.arrayify(hashed);
      console.log('signature', voucher.data.signature);
      // const signature = userSigner.signMessage(arrayified);
          
      const result = ethers.utils.verifyMessage(arrayified, voucher.data.signature);
      // console.log('result', result);
      
      if(result !== clientAddress){
         console.log('Not verified by client');
         return;
      }
